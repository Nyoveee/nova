...
public:
	FRAMEWORK_DLL_API CustomShader(ResourceID id, ResourceFilePath resourceFilePath,BlendingConfig blendingConfig, DepthTestingMethod depthTestingMethod, const char* fShaderCode, std::unordered_map<ShaderVariableName, ShaderVariableType> const& uniforms);
