...
EquirectangularMap::EquirectangularMap(ResourceID id, ResourceFilePath resourceFilePath, gli::texture const& texture, gli::gl::format const& format) :
...
EquirectangularMap::EquirectangularMap(EquirectangularMap&& other) noexcept :
...
EquirectangularMap& EquirectangularMap ::operator=(EquirectangularMap&& other) noexcept {
...
GLuint EquirectangularMap::getTextureId() const {
	return textureId;
}