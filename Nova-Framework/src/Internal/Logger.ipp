...
inline void Logger::warn(std::string_view rt_fmt_str, Args&&... args)
{
...
template<typename ...Args>
inline void Logger::info(std::string_view rt_fmt_str, Args&&... args)
{
    std::size_t argSize{ sizeof...(args) };
    std::string message;
...
template<typename ...Args>
inline void Logger::error(std::string_view rt_fmt_str, Args&&... args)
{
    std::size_t argSize{ sizeof...(args) };
    std::string message;
