...
public:
	...
	FRAMEWORK_DLL_API int getMaxTiles() const;
	
	/// Gets the tile at the specified index.
	///  @param[in]	i		The tile index. [Limit: 0 >= index < #getMaxTiles()]
	/// @return The tile at the specified index.
	FRAMEWORK_DLL_API const dtMeshTile* getTile(int i) const;
	...
	/// @return The status flags for the operation.
	FRAMEWORK_DLL_API dtStatus getTileAndPolyByRef(const dtPolyRef ref, const dtMeshTile** tile, const dtPoly** poly) const;
	...
	FRAMEWORK_DLL_API dtPolyRef getPolyRefBase(const dtMeshTile* tile) const;
...
///  @ingroup detour
FRAMEWORK_DLL_API dtNavMesh* dtAllocNavMesh();

/// Frees the specified navigation mesh object using the Detour allocator.
///  @param[in]	navmesh		A navigation mesh allocated using #dtAllocNavMesh
///  @ingroup detour
FRAMEWORK_DLL_API void dtFreeNavMesh(dtNavMesh* navmesh);
