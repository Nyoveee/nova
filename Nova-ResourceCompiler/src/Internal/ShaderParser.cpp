...
/******************************************************************************
	Sub Parsers
******************************************************************************/
bool ParseTags(std::string& data, ShaderParserData& shaderParserData)
{
	// Get full definition
...
bool ParseUniforms(std::string& data, ShaderParserData& shaderParserData) {
	// Get full definition
...
bool ParseFragmentShader(std::string& data, ShaderParserData& shaderParserData) {
	// Get full definition
...
******************************************************************************/ 
bool ShaderParser::Parse(AssetFilePath const& intermediaryAssetFilepath, ShaderParserData& shaderParserData)
{
	...
	for (std::pair<std::string, std::string> uniform : shaderParserData.uniforms) {
		Logger::info("Uniform = {}, Type = {}", uniform.first, uniform.second);
	}
