...
int main() {
	...
	Window			window			{ gameConfig.gameName.c_str(), {windowWidth, windowHeight}, gameConfig, Window::Configuration::Restored, inputManager, Window::Viewport::ChangeDuringResize};
