...
class Shockwave : Script
{
    ...
    [SerializableField] private float duration = 5f;
    ...
    protected override void update()
    {
        ...
        float heightSize = Mathf.Interpolate(0f, maxRadius / 1.3f, interval, motionLerpPower);
        ...
        foreach(GameObject child in gameObject.GetChildren())
        {
            ...
            if(emitter != null)
            {
                emitter.setRadius(lerpedSize);
                float radiusFactor = lerpedSize / initialParticleRadius;
                emitter.particleRate = initialParticleRate * radiusFactor;
            }
        }
