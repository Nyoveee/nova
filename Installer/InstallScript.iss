...
DefaultDirName={commonpf}\DigiPen\Ichorus

; Start menu directory
DefaultGroupName=DigiPen\Ichorus

; Output directory for the installer.
OutputDir=.\INSTALLER

; Setup executable installer
OutputBaseFilename=Ichorus_Setup
...
Source: .\REDIST\dotnet_runtime_9_x64.exe; DestDir: {tmp}; Flags: ignoreversion
...
[Icons]
Name: {group}\Ichorus; Filename: {app}\Ichorus.exe; WorkingDir: {app}; IconFilename: "{app}\Icon.ico"
...
Name: {commondesktop}\Ichorus; Filename: {app}\Ichorus.exe; Tasks: desktopicon; WorkingDir: {app}; IconFilename: "{app}\Icon.ico"
...
Filename: {tmp}\dotnet_runtime_9_x64.exe; Parameters: /install /quiet /norestart; StatusMsg: Installing .NET 9 Runtime...
;Filename: {tmp}\dxwebsetup.exe; Parameters: /q; StatusMsg: Installing DirectX...
Filename: {app}\Ichorus.exe; Description: {cm:LaunchProgram,GameTest}; Flags: nowait postinstall skipifsilent
