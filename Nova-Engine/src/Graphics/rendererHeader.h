...
// Therefore, TransparentBatch is combination of both.
...
struct RenderQueue {
	...
	// we map material id to index of the respective vectors..
	std::unordered_map<ResourceID, int> materialResourceIdToOpaqueIndex;
};
